...
let home,register,record,viewer = false;

if (currentpath=='/callender'){
  home = true
  register,record,viewer = false;
}
if (currentpath=='/practice_register'){
  register = true
  home,record,viewer = false;
}
